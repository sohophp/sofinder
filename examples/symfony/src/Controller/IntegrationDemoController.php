...
<body>
<main class="shell">
  <section class="hero"><h1>SoFinder 编辑器集成演示</h1><p>同一个安全 Picker SDK 连接 CKEditor 5、TinyMCE、TipTap、Quill、wangEditor 和普通表单。先用 <strong>demo / demo</strong> 登录。</p></section>
  <nav class="tabs" aria-label="编辑器"><button class="active" data-pane="plain">普通表单</button><button data-pane="ckeditor">CKEditor 5</button><button data-pane="tinymce">TinyMCE 8</button><button data-pane="tiptap">TipTap</button><button data-pane="quill">Quill 2</button><button data-pane="wangeditor">wangEditor 5</button></nav>
  <section class="card">
...
<script type="module">
  import { registerQuill, registerTinyMce, selectForCkeditor5, selectForInput, selectForTiptap, selectForWangEditor } from '/sofinder/assets/sofinder-picker.js';
