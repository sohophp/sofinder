...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	var P = RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"), kt = {}, F = {};
	function I(e) {
		return Oe.call(F, e) ? !0 : Oe.call(kt, e) ? !1 : P.test(e) ? F[e] = !0 : (kt[e] = !0, !1);
	}
	function At(e, t, n) {
		if (I(t)) {
	...
	function mc(e, t, n) {
		...
		if (a !== null) {
			...
			if (so(t), i) {
				...
				if (r = K, r !== null && (o = st(r, n), o !== 0 && o !== a.retryLane)) throw a.retryLane = o, ai(e, o), hu(r, e, o), rc;
				Du(), t = pc(e, t, n);
	...
	function Cc(e, t, n) {
		...
		if (l !== null && (c = l.dehydrated, c !== null)) {
			if (a) t.flags & 256 ? (oo(t), t.flags &= -257, t = Ec(e, t, n)) : t.memoizedState === null ? (lo(t), c = r.fallback, i = t.mode, r = Tc({
				...
				if (o = K, o !== null && (r = st(o, n), r !== 0 && r !== l.retryLane)) throw l.retryLane = r, ai(e, r), hu(o, e, r), rc;
				af(c) || Du(), t = Ec(e, t, n);
	...
	function Nc(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 3:
				...
				return t;
			case 26: return hc(e, t), e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : R || (n = t.type, e = t.pendingProps, r = Bd(he.current).createElement(n), r[pt] = t, r[mt] = e, Pd(r, n, e), M(r), t.stateNode = r) : t.memoizedState = kf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
			case 27: return ye(t), e === null && R && (r = t.stateNode = ff(t.type, t.pendingProps, he.current), Fi = t, Li = !0, i = L, Zd(t.type) ? (lf = i, L = cf(r.firstChild)) : L = i), ac(e, t, t.pendingProps.children, n), hc(e, t), e === null && (t.flags |= 4194304), t.child;
			case 5: return e === null && R && ((i = r = L) && (r = tf(r, t.type, t.pendingProps, Li), r === null ? i = !1 : (t.stateNode = r, Fi = t, L = cf(r.firstChild), Li = !1, i = !0)), i || zi(t)), ye(t), i = t.type, a = t.pendingProps, o = e === null ? null : e.memoizedProps, r = a.children, Ud(i, a) ? r = null : o !== null && Ud(i, o) && (t.flags |= 32), t.memoizedState !== null && (i = Co(e, t, Eo, null, null, n), Qf._currentValue = i), hc(e, t), ac(e, t, r, n), t.child;
	...
	function zc(e, t, n) {
		...
		switch (Ni(t), t.tag) {
			...
			case 19:
				...
				return r.tail === null ? (U(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Ne(), e.sibling = null, n = z.current, A(z, i ? n & 1 | 2 : n & 1), R && Ai(t, r.treeForkCount), e);
			case 22:
	...
	function Lu(e, t, n, r, i, a, o, c, l) {
		...
		if (t !== null) {
			...
			if (a = t.lanes | t.childLanes, a |= ti, it(e, n, a, o, c, l), e === K && (q = K = null, J = 0), ou = t, au = e, su = n, cu = a, lu = i, uu = r, t.subtreeFlags & 10256 || t.flags & 10256 ? (e.callbackNode = null, e.callbackPriority = 0, Xu(Le, function() {
				return Uu(), null;
	...
	Zr(Hr, "onAnimationEnd"), Zr(Ur, "onAnimationIteration"), Zr(Wr, "onAnimationStart"), Zr("dblclick", "onDoubleClick"), Zr("focusin", "onFocus"), Zr("focusout", "onBlur"), Zr(Gr, "onTransitionRun"), Zr(Kr, "onTransitionStart"), Zr(qr, "onTransitionCancel"), Zr(Jr, "onTransitionEnd"), Ot("onMouseEnter", ["mouseout", "mouseover"]), Ot("onMouseLeave", ["mouseout", "mouseover"]), Ot("onPointerEnter", ["pointerout", "pointerover"]), Ot("onPointerLeave", ["pointerout", "pointerover"]), N("onChange", "change click focusin focusout input keydown keyup selectionchange".split(" ")), N("onSelect", "focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")), N("onBeforeInput", [
		"compositionend",
		"keypress",
		"textInput",
		"paste"
	...
	function wd(e, t, n, r, i) {
		...
		ln(function() {
			...
			if (!(t & 7)) {
				a: {
					if (s = e === "mouseover" || e === "pointerover", c = e === "mouseout" || e === "pointerout", s && n !== nn && (u = n.relatedTarget || n.fromElement) && (St(u) || u[ht])) break a;
					if ((c || s) && (s = i.window === i ? i : (s = i.ownerDocument) ? s.defaultView || s.parentWindow : window, c ? (u = n.relatedTarget || n.toElement, c = r, u = u ? St(u) : null, u !== null && (f = l(u), d = u.tag, u !== f || d !== 5 && d !== 27 && d !== 6) && (u = null)) : (c = null, u = r), c !== u)) {
						if (d = An, g = "onMouseLeave", p = "onMouseEnter", m = "mouse", (e === "pointerout" || e === "pointerover") && (d = Hn, g = "onPointerLeave", p = "onPointerEnter", m = "pointer"), f = c == null ? s : wt(c), h = u == null ? s : wt(u), s = new d(g, m + "leave", c, n, i), s.target = f, s.relatedTarget = h, g = null, St(i) === r && (d = new d(p, m + "enter", u, n, i), d.target = h, d.relatedTarget = f, g = d), f = g, c && u) b: {
				...
				a: {
					if (s = r ? wt(r) : window, c = s.nodeName && s.nodeName.toLowerCase(), c === "select" || c === "input" && s.type === "file") var v = fr;
					else if (or(s)) {
						if (pr) v = Sr;
						else {
							v = br;
...
function T({ entry: e, info: t, imageUrl: n, labels: r, onClose: i, onSave: a }) {
	...
	}, me = (e, t) => e === "nw" || e === "se" ? "nwse-resize" : e === "ne" || e === "sw" ? "nesw-resize" : e === "n" || e === "s" ? "ns-resize" : e === "e" || e === "w" ? "ew-resize" : t ? "move" : "crosshair", he = (e) => {
		e.currentTarget.setPointerCapture(e.pointerId);
		let t = A(e), n = pe(t, e.pointerType), r = t.x >= u.x && t.x <= u.x + u.width && t.y >= u.y && t.y <= u.y + u.height;
		c.current = {
			...
			panX: b.x,
			panY: b.y
		}, D(e.altKey || e.button === 1 ? "grabbing" : me(n, r)), p((e) => [...e.slice(-39), u]), h([]);
	}, ge = (e) => {
		if (!c.current) {
			let t = A(e), n = t.x >= u.x && t.x <= u.x + u.width && t.y >= u.y && t.y <= u.y + u.height;
			D(me(pe(t, e.pointerType), n));
			return;
		}
				...
				children: /* @__PURE__ */ (0, S.jsx)("canvas", {
					...
					onKeyDown: (e) => {
						...
						n && (e.preventDefault(), k({
							...
							x: u.x + n[0],
							y: u.y + n[1]
						})), (e.ctrlKey || e.metaKey) && e.key.toLowerCase() === "z" && (e.preventDefault(), e.shiftKey ? ve() : _e());
					}
				})
			}),
			/* @__PURE__ */ (0, S.jsxs)("div", {
...
var oe = ({ kind: e }) => e === "folder" ? /* @__PURE__ */ (0, S.jsxs)("svg", {
	viewBox: "0 0 48 48",
	"aria-hidden": "true",
	...
	}), [e]), a) return /* @__PURE__ */ (0, S.jsx)(oe, { kind: "image" });
...
}, le = (e) => e < 1024 ? `${e} B` : e < 1024 ** 2 ? `${(e / 1024).toFixed(1)} KB` : `${(e / 1024 ** 2).toFixed(1)} MB`, E = (e) => Array.from(e).length;
//#endregion
//#region src/components/UploadQueue.tsx
function D({ tasks: e, collapsed: t, labels: n, onToggle: r, onCancel: i, onCancelAll: a, onClearFinished: o, onRemove: s }) {
	if (e.length === 0) return null;
...
function ue({ api: e, resource: t, selectedEntries: n, selected: r, imageInfo: i, metadata: a, showTags: o, previewImage: s, selectMode: c, selectAllowed: l, labels: u, formatDate: d, onChoose: f, onOpenUrl: p }) {
	return /* @__PURE__ */ (0, S.jsxs)("aside", {
		...
		children: [/* @__PURE__ */ (0, S.jsx)("h2", { children: u.details }), n.length > 1 ? /* @__PURE__ */ (0, S.jsxs)("div", {
			...
			/* @__PURE__ */ (0, S.jsx)("div", {
				...
				children: s ? /* @__PURE__ */ (0, S.jsx)(ce, {
					src: e.thumbnailUrl(t, r, 800, 600),
					alt: r.name
				}) : /* @__PURE__ */ (0, S.jsx)(oe, { kind: r.directory ? "folder" : "file" })
			}),
			...
			/* @__PURE__ */ (0, S.jsxs)("dl", { children: [
				...
				/* @__PURE__ */ (0, S.jsx)("dd", { children: r.directory ? "—" : le(r.size) }),
...
function de({ resource: e, tools: t, features: n, translate: r, onToolChange: i, onFeatureChange: a, onClose: o }) {
	let s = r;
	return /* @__PURE__ */ (0, S.jsxs)(C, {
		title: s("settings"),
		closeLabel: s("close"),
		...
		children: [
			/* @__PURE__ */ (0, S.jsx)("p", { children: s("toolSettingsHint") }),
			...
			/* @__PURE__ */ (0, S.jsx)("h3", { children: s("imageTools") }),
			[
				"resize",
				"crop",
				"rotate",
				...
				}), /* @__PURE__ */ (0, S.jsx)("span", { children: s(e === "presets" ? "preset" : e === "rotate" ? "rotationTools" : e) })]
			}, e)),
			/* @__PURE__ */ (0, S.jsx)("h3", { children: s("optionalFeatures") }),
			/* @__PURE__ */ (0, S.jsx)("p", { children: s("featureSettingsHint") }),
			[
				"autoCollapseUploads",
				"folderTree",
				"recent",
				...
				}), /* @__PURE__ */ (0, S.jsx)("span", { children: s(e === "folderTree" ? "folderTreeFeature" : e === "favorites" ? "favoriteFeature" : e === "archive" ? "archiveFeature" : e === "trash" ? "trashFeature" : e === "tags" ? "tagsFeature" : e === "recent" ? "recentFeature" : "autoCollapseUploads") })]
			}, e))
		]
	});
}
...
function fe({ state: e, unsafe: t, translate: n, onBrowse: r, onConfirm: i, onClose: a }) {
				...
				children: e.loading ? /* @__PURE__ */ (0, S.jsx)("div", {
					...
					children: [
						/* @__PURE__ */ (0, S.jsx)("span", {
							...
							children: /* @__PURE__ */ (0, S.jsx)(oe, { kind: "folder" })
						}),
						t.name,
...
var O = {
...
}, pe = () => A("sofinder.imageTools.v2", O), me = {
	left: {
		initial: 220,
		min: 110,
		max: 330
	...
	let t = Number(localStorage.getItem(`sofinder.column.${e}`)), n = me[e];
...
function ge({ config: e }) {
	let t = (0, l.useMemo)(() => new g(e), [e]), [n, r] = (0, l.useState)(() => {
		...
		dateStyle: "medium",
		timeStyle: "short"
	}), [n]), [o, s] = (0, l.useState)([]), [c, u] = (0, l.useState)(e.resource), [d, f] = (0, l.useState)(""), [p, m] = (0, l.useState)([]), [_, v] = (0, l.useState)(() => /* @__PURE__ */ new Set()), [y, x] = (0, l.useState)(null), [O, ge] = (0, l.useState)(""), [_e, ve] = (0, l.useState)("name"), [ye, be] = (0, l.useState)("name"), [xe, Se] = (0, l.useState)("asc"), [Ce, we] = (0, l.useState)(0), [Te, Ee] = (0, l.useState)(0), [De, Oe] = (0, l.useState)(() => localStorage.getItem("sofinder.view") === "list" ? "list" : "grid"), [ke, Ae] = (0, l.useState)(!0), [je, Me] = (0, l.useState)(""), [Ne, Pe] = (0, l.useState)([]), [Fe, Ie] = (0, l.useState)(!1), [Le, Re] = (0, l.useState)({
		favorites: [],
		tags: {},
		recent: []
	}), [ze, Be] = (0, l.useState)(null), [Ve, He] = (0, l.useState)(pe), [j, Ue] = (0, l.useState)(() => A("sofinder.features.v2", {
		...k,
		folderTree: e.featureDefaults?.folderTree ?? !1
	})), [We, Ge] = (0, l.useState)(!1), [Ke, qe] = (0, l.useState)(null), [Je, Ye] = (0, l.useState)(!1), [Xe, Ze] = (0, l.useState)(null), [Qe, $e] = (0, l.useState)(null), [et, tt] = (0, l.useState)(!1), [nt, rt] = (0, l.useState)(!1), [it, at] = (0, l.useState)(null), [ot, st] = (0, l.useState)(null), [ct, lt] = (0, l.useState)(null), [ut, dt] = (0, l.useState)({}), [ft, pt] = (0, l.useState)({
		driver: "",
		formats: []
	}), [mt, ht] = (0, l.useState)({}), [gt, _t] = (0, l.useState)(() => he("left")), [vt, yt] = (0, l.useState)(() => he("right")), bt = (0, l.useRef)(null), xt = (0, l.useRef)(/* @__PURE__ */ new Map()), St = (0, l.useRef)(0), Ct = (0, l.useRef)(null), wt = (0, l.useRef)(null), Tt = (0, l.useRef)(null);
	(0, l.useEffect)(() => {
		let t = {
			accent: "--sf-accent",
			background: "--sf-bg",
	...
	let M = (0, l.useCallback)((e) => Me(e instanceof Error ? e.message : i("error")), [i]), Et = (0, l.useCallback)((e) => new Promise((t) => {
		Ct.current?.(!1), Ct.current = t, $e(e);
	}), []), Dt = (e) => {
		let t = Ct.current;
		Ct.current = null, $e(null), t?.(e);
	}, N = (0, l.useCallback)(async (e = c, n = d, r = O, i = Ce, a = ye, o = xe, s = _e) => {
		if (e) {
			Ae(!0), Me("");
			try {
				let c = await t.list(e, n, r, a, o, i, 100, s);
				m(c.entries), f(c.path), we(c.offset), Ee(c.total), ht(c.capabilities || {}), v(/* @__PURE__ */ new Set()), x(null);
			} catch (e) {
				M(e);
			} finally {
				Ae(!1);
	...
	(0, l.useEffect)(() => {
		...
		e.length > 0 && (Pe((t) => [...t.filter((e) => !e.id.startsWith("pending-")), ...e]), Ie(!1));
	}, [t, i]), (0, l.useEffect)(() => {
		...
		if (!j.autoCollapseUploads || Ne.length === 0 || Ne.some((e) => e.status === "queued" || e.status === "uploading")) return;
		let e = window.setTimeout(() => Ie(!0), 1200);
		return () => window.clearTimeout(e);
	}, [j.autoCollapseUploads, Ne]), (0, l.useEffect)(() => {
		let e = (e) => {
			let t = Array.from(e.clipboardData?.files || []);
			t.length > 0 && !P?.readOnly && mt.upload !== !1 && (e.preventDefault(), Bt(t));
		};
		return window.addEventListener("paste", e), () => window.removeEventListener("paste", e);
	});
	let Ot = (0, l.useMemo)(() => d === "" ? [] : d.split("/"), [d]), P = o.find((e) => e.name === c), kt = d === "" ? 0 : d.split("/").length, F = (0, l.useMemo)(() => p.filter((e) => _.has(e.path)), [p, _]), I = F.length === 1 ? F[0] : null, At = (e) => ft.formats.find((t) => e.mimeType !== null && t.mimes.includes(e.mimeType.toLowerCase())), jt = (e) => !!(e && At(e)?.thumbnail), Mt = (e) => !!(e && At(e)?.edit), Nt = (t) => !!(t && !t.directory && t.url && (e.selectionKind !== "image" || At(t)?.webEmbeddable)), Pt = (e) => {
		e.directory || lt({
			url: new URL(e.url || t.downloadUrl(c, e.path), document.baseURI).href,
			loginRequired: !e.url
		});
	}, Ft = (e) => F.length > 0 && F.every((t) => t.capabilities?.[e] !== !1);
	(0, l.useEffect)(() => {
		if (Be(null), !I || !At(I)?.read) return;
		let e = !0;
	...
	let It = (e, n) => {
		...
		}) : v(/* @__PURE__ */ new Set([e.path])), x(e.path), j.recent && t.updateMetadata(c, e.path, "touch").then(Re).catch(() => void 0);
	}, Lt = (e) => {
		e.directory ? N(c, e.path, O, 0) : Yt(e);
	}, Rt = async () => {
		P && Ze({
			kind: "folder",
			title: i("newFolder"),
		...
		let r = Array.from(e), a = P ? r.filter((e) => E(e.name) <= P.maxFileNameLength) : r;
		a.length !== r.length && P && Me(`${i("fileNameTooLong")} ${P.maxFileNameLength}`);
		let o = a.map((e) => {
			let r = `${Date.now()}-${++St.current}`, i = new AbortController();
			xt.current.set(r, i);
		...
		Pe((e) => [...e.filter((e) => !s.has(e.id)), ...o.map(({ id: e, file: t, pendingId: n }) => ({
			id: e,
			name: t.name,
			progress: 0,
			status: "queued",
			...
			for (; l < o.length;) {
				...
				try {
					for (;;) try {
						...
						if (t instanceof h && t.code === "conflict" && !r && await Et({
							title: i("replaceFile"),
							message: e.file.name,
		...
		xt.current.get(e)?.abort(), zt(e, {
			status: "cancelled",
			message: i("cancelled")
		});
	}, Ut = () => {
		xt.current.forEach((e) => e.abort()), Pe((e) => e.map((e) => e.status === "queued" || e.status === "uploading" ? {
			...e,
			status: "cancelled",
			message: i("cancelled")
		} : e));
	}, Wt = (e) => {
		xt.current.get(e)?.abort(), xt.current.delete(e), Pe((t) => t.filter((t) => t.id !== e));
	}, Gt = async () => {
		if (!I || !P) return;
		...
		if (!(F.length === 0 || !await Et({
			...
			Me(e.purgedItems > 0 ? `${n} · ${i("trashAutoPurged")} ${e.purgedItems} ${i("items")} (${le(e.purgedBytes)})` : n), await N();
		} catch (e) {
			M(e);
		}
	}, qt = async (e, n) => {
		try {
			...
			qe(null), Me(r.failed === 0 ? `${r.succeeded} ${i("completed")}` : `${r.succeeded} ${i("completed")}, ${r.failed} ${i("failed")}`), await N();
		} catch (e) {
			M(e);
		}
	}, Jt = async (e, n) => {
		...
		if (!Nt(t)) {
			t && e.selectionKind === "image" && Me(i("webImageUnsupported"));
			return;
		}
		if (t?.url) {
		...
		if (!(!I || !Mt(I))) {
			...
			try {
				...
				Me(`${i("imageCreated")}: ${o.entry.name} · ${o.result.width} × ${o.result.height} px`), await N();
			} catch (e) {
				M(e), Ae(!1);
			}
		}
		...
		if (I) try {
			Re(await t.updateMetadata(c, I.path, "favorite", { favorite: !Le.favorites.includes(I.path) }));
		} catch (e) {
			M(e);
		}
	}, an = async () => {
		...
		Oe(e), localStorage.setItem("sofinder.view", e);
	}, ln = (e) => {
		let n = it?.entry ?? null;
		at(null), e === "open" && n?.directory ? Lt(n) : e === "preview" && n && !n.directory ? st(n) : e === "select" && n ? Yt(n) : e === "rename" ? Gt() : e === "copy" ? Jt("copy", d) : e === "move" ? Jt("move", d) : e === "delete" ? Kt() : e === "download" && n && !n.directory && window.location.assign(t.downloadUrl(c, n.path));
	}, un = async (e) => {
		if (I) try {
			...
			Me(`${i("imageCreated")}: ${n.entry.name} · ${n.result.width} × ${n.result.height} px`), await N();
		} catch (e) {
			M(e);
		}
	}, dn = (e) => {
		...
		e === "left" ? _t(i) : yt(i), n && localStorage.setItem(`sofinder.column.${e}`, String(i));
	}, pn = (e, t) => {
		...
		t.currentWidth = Math.round(Math.max(r.min, Math.min(r.max, t.startWidth + (t.side === "left" ? n : -n)))), fn(t.side, t.currentWidth);
	}, hn = () => {
		let e = Tt.current;
		Tt.current = null, e && fn(e.side, e.currentWidth, !0);
	}, gn = (e, t) => {
		let n = t.key === "ArrowLeft" ? -1 : +(t.key === "ArrowRight");
		n !== 0 && (t.preventDefault(), fn(e, (e === "left" ? gt : vt) + (e === "left" ? n : -n) * 10, !0));
	}, _n = (e) => {
		...
		if (e.key === "Delete" && Ft("delete") && !P?.readOnly) {
			e.preventDefault(), Kt();
			return;
		}
		if (e.key === "F2" && F.length === 1 && Ft("rename") && !P?.readOnly) {
			e.preventDefault(), Gt();
			return;
		}
		if (e.key === "Enter" && F.length === 1) {
			e.preventDefault(), Lt(F[0]);
			return;
		}
		...
		if (r !== 0 && p.length > 0) {
			...
			v(/* @__PURE__ */ new Set([a.path])), x(a.path), dn(i);
		}
	}, vn = Ke !== null && F.some((e) => {
		let t = e.path.includes("/") ? e.path.slice(0, e.path.lastIndexOf("/")) : "", n = Ke.path === "" ? 0 : Ke.path.split("/").length;
		return Ke.operation === "move" && Ke.path === t || e.directory && P !== void 0 && n >= P.maxFolderDepth || e.directory && (Ke.path === e.path || Ke.path.startsWith(`${e.path}/`));
	}), yn = Ne.some((e) => e.status === "queued" || e.status === "uploading");
	return /* @__PURE__ */ (0, S.jsxs)("main", {
		className: "sf-app",
		onKeyDown: _n,
		onDragOver: (e) => e.preventDefault(),
		onDrop: (e) => {
			e.preventDefault(), e.dataTransfer.files.length && Bt(e.dataTransfer.files);
		},
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, S.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, S.jsx)("input", {
								disabled: _e === "name" && P?.storageCapabilities?.search === !1,
								value: O,
								onChange: (e) => ge(e.target.value),
								placeholder: i(_e === "tags" ? "searchTags" : "search"),
								"aria-label": i(_e === "tags" ? "searchTags" : "search")
							})
						]
					}),
					/* @__PURE__ */ (0, S.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, S.jsxs)("label", {
							...
							role: "group",
							children: [/* @__PURE__ */ (0, S.jsx)("button", {
								className: De === "grid" ? "active" : "",
								onClick: () => cn("grid"),
								title: i("grid"),
								children: "▦"
							}), /* @__PURE__ */ (0, S.jsx)("button", {
								className: De === "list" ? "active" : "",
								onClick: () => cn("list"),
								title: i("list"),
								children: "☷"
							})]
			...
			/* @__PURE__ */ (0, S.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, S.jsxs)("button", {
						onClick: Rt,
						disabled: P?.readOnly || mt.create_folder === !1 || P !== void 0 && kt >= P.maxFolderDepth,
						title: P && kt >= P.maxFolderDepth ? i("folderDepthReached") : void 0,
						children: ["＋ ", i("newFolder")]
					}),
					/* @__PURE__ */ (0, S.jsxs)("button", {
						className: `primary sf-upload-trigger${yn ? " is-active" : ""}`,
						"aria-busy": yn,
						onClick: () => bt.current?.click(),
						disabled: P?.readOnly || mt.upload === !1,
						children: [
							"↑ ",
							i("upload"),
							yn ? ` (${Ne.filter((e) => e.status === "queued" || e.status === "uploading").length})` : ""
						]
					}),
					/* @__PURE__ */ (0, S.jsx)("input", {
						ref: bt,
						...
						hidden: !0,
						onChange: (e) => {
							e.target.files && Bt(e.target.files), e.target.value = "";
						}
					}),
					...
					/* @__PURE__ */ (0, S.jsxs)("button", {
						onClick: Gt,
						disabled: F.length !== 1 || !Ft("rename") || P?.readOnly,
						children: ["✎ ", i("rename")]
					}),
					/* @__PURE__ */ (0, S.jsxs)("button", {
						onClick: () => void Jt("copy", d),
						disabled: !Ft("copy") || P?.readOnly,
						children: ["▣ ", i("copy")]
					}),
					/* @__PURE__ */ (0, S.jsxs)("button", {
						onClick: () => void Jt("move", d),
						disabled: !Ft("move") || P?.readOnly,
						children: ["↗ ", i("move")]
					}),
					...
					j.favorites && /* @__PURE__ */ (0, S.jsxs)("button", {
						...
						disabled: !I,
						children: [
							I && Le.favorites.includes(I.path) ? "★" : "☆",
							" ",
							i("favorite")
						]
					}),
					...
					Ve.rotate && /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsxs)("button", {
						onClick: () => void Zt(270),
						disabled: !Mt(I) || P?.readOnly,
					...
					Ve.resize && /* @__PURE__ */ (0, S.jsxs)("button", {
						onClick: Qt,
						disabled: !Mt(I) || P?.readOnly,
						children: ["↔ ", i("resize")]
					}),
					Ve.crop && /* @__PURE__ */ (0, S.jsxs)("button", {
						onClick: $t,
						disabled: !Mt(I) || !ze || P?.readOnly,
						children: ["▣ ", i("crop")]
					}),
					Ve.presets && /* @__PURE__ */ (0, S.jsxs)("label", {
						className: "sf-sort",
						children: [i("preset"), /* @__PURE__ */ (0, S.jsxs)("select", {
							value: "",
							disabled: !Mt(I) || P?.readOnly || Object.keys(ut).length === 0,
							onChange: (e) => {
								let t = e.target.value;
								e.target.value = "", t && un(t);
							},
							children: [/* @__PURE__ */ (0, S.jsx)("option", {
								value: "",
								children: "—"
							}), Object.entries(ut).map(([e, t]) => /* @__PURE__ */ (0, S.jsxs)("option", {
								value: e,
								children: [
									e,
									" (",
			...
			je && /* @__PURE__ */ (0, S.jsxs)("div", {
				className: "sf-notice",
				role: "alert",
				children: [je, /* @__PURE__ */ (0, S.jsx)("button", {
					onClick: () => Me(""),
					children: "×"
				})]
			}),
			/* @__PURE__ */ (0, S.jsx)(D, {
				...
				onCancel: Ht,
				onCancelAll: Ut,
				onClearFinished: () => Pe((e) => e.filter((e) => e.status === "queued" || e.status === "uploading")),
				onRemove: Wt
			}),
			/* @__PURE__ */ (0, S.jsxs)("div", {
				className: "sf-layout",
				style: {
					"--sf-sidebar-width": `${gt}px`,
					"--sf-details-width": `${vt}px`
				},
				children: [
						...
						children: [
							...
							o.map((e) => /* @__PURE__ */ (0, S.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, S.jsx)("span", {
									...
									children: /* @__PURE__ */ (0, S.jsx)(oe, { kind: e.name.toLowerCase().includes("image") ? "image" : "folder" })
							...
							j.recent && Le.recent.length > 0 && /* @__PURE__ */ (0, S.jsxs)("div", {
								className: "sf-recent",
								children: [/* @__PURE__ */ (0, S.jsxs)("header", { children: [/* @__PURE__ */ (0, S.jsx)("strong", { children: i("recent") }), /* @__PURE__ */ (0, S.jsx)("span", { children: Le.recent.length })] }), Le.recent.slice(0, 8).map((e) => /* @__PURE__ */ (0, S.jsxs)("button", {
									title: e.path,
									onClick: () => void sn(e.path),
									children: [/* @__PURE__ */ (0, S.jsx)("span", {
					...
					/* @__PURE__ */ (0, S.jsx)("div", {
						...
						"aria-valuenow": gt,
						onPointerDown: (e) => pn("left", e),
						onPointerMove: mn,
						onPointerUp: hn,
						onPointerCancel: hn,
						onKeyDown: (e) => gn("left", e),
						onDoubleClick: () => fn("left", me.left.initial, !0)
					}),
					/* @__PURE__ */ (0, S.jsxs)("section", {
						...
						children: [
							/* @__PURE__ */ (0, S.jsxs)("nav", {
								...
								children: [/* @__PURE__ */ (0, S.jsx)("button", {
									onClick: () => void N(c, "", O, 0),
									children: i("home")
								}), Ot.map((e, t) => /* @__PURE__ */ (0, S.jsxs)("span", { children: ["› ", /* @__PURE__ */ (0, S.jsx)("button", {
									onClick: () => void N(c, Ot.slice(0, t + 1).join("/"), O, 0),
									children: e
								})] }, `${e}-${t}`))]
							}),
							ke ? /* @__PURE__ */ (0, S.jsx)("div", {
								className: "sf-state",
								children: i("loading")
								...
								className: `sf-entries ${De}`,
								role: "listbox",
								"aria-multiselectable": "true",
								"aria-label": i("files"),
								children: [De === "list" && /* @__PURE__ */ (0, S.jsxs)("div", {
									...
									let r = !e.directory && jt(e);
									return /* @__PURE__ */ (0, S.jsxs)("button", {
										"data-entry-index": n,
										role: "option",
										"aria-selected": _.has(e.path),
										"aria-label": `${e.name}, ${e.directory ? i("folder") : le(e.size)}`,
										className: `sf-entry ${_.has(e.path) ? "selected" : ""}`,
										onClick: (t) => It(e, t),
										onDoubleClick: () => Lt(e),
										onContextMenu: (t) => {
											t.preventDefault(), v(/* @__PURE__ */ new Set([e.path])), x(e.path), at({
												x: t.clientX,
												y: t.clientY,
												entry: e
											});
										...
										onPointerDown: (t) => {
											t.pointerType === "touch" && (wt.current = window.setTimeout(() => {
												v(/* @__PURE__ */ new Set([e.path])), x(e.path), at({
													x: t.clientX,
													y: t.clientY,
													entry: e
												});
										...
										onDrop: (t) => {
											e.directory && t.dataTransfer.files.length && (t.preventDefault(), Vt(e.path, t.dataTransfer.files));
										},
										children: [
											/* @__PURE__ */ (0, S.jsx)("span", {
												className: "sf-entry-icon",
												children: r ? /* @__PURE__ */ (0, S.jsx)(ce, {
													src: t.thumbnailUrl(c, e),
													alt: "",
													lazy: !0
												}) : /* @__PURE__ */ (0, S.jsx)(oe, { kind: e.directory ? "folder" : "file" })
											}),
											/* @__PURE__ */ (0, S.jsxs)("span", {
												className: "sf-entry-name",
												title: e.name,
												children: [j.favorites && Le.favorites.includes(e.path) && /* @__PURE__ */ (0, S.jsx)("span", {
											...
											/* @__PURE__ */ (0, S.jsx)("span", {
												...
												children: e.directory ? "—" : le(e.size)
											}),
							...
							Te > 100 && /* @__PURE__ */ (0, S.jsxs)("nav", {
								className: "sf-pagination",
								"aria-label": i("pagination"),
								children: [
									/* @__PURE__ */ (0, S.jsxs)("button", {
										disabled: Ce === 0,
										onClick: () => void N(c, d, O, Math.max(0, Ce - 100)),
										children: ["‹ ", i("previous")]
									}),
									/* @__PURE__ */ (0, S.jsxs)("span", { children: [
										Math.floor(Ce / 100) + 1,
					...
					/* @__PURE__ */ (0, S.jsx)("div", {
						...
						"aria-valuenow": vt,
						onPointerDown: (e) => pn("right", e),
						onPointerMove: mn,
						onPointerUp: hn,
						onPointerCancel: hn,
						onKeyDown: (e) => gn("right", e),
						onDoubleClick: () => fn("right", me.right.initial, !0)
					}),
					/* @__PURE__ */ (0, S.jsx)(ue, {
						api: t,
						resource: c,
			...
			We && /* @__PURE__ */ (0, S.jsx)(de, {
				...
				onToolChange: en,
				onFeatureChange: (e, t) => {
					tn(e, t), e === "tags" && !t && _e === "tags" && ve("name");
				},
				onClose: () => Ge(!1)
			}),
			Ke && /* @__PURE__ */ (0, S.jsx)(fe, {
				state: Ke,
				unsafe: vn,
				translate: i,
				onBrowse: (e, t) => void Jt(e, t),
				onConfirm: (e, t) => void qt(e, t),
				onClose: () => qe(null)
			}),
			Xe && /* @__PURE__ */ (0, S.jsx)(w, {
				title: Xe.title,
				label: Xe.label,
				initialValue: Xe.initial,
				maximum: Xe.maximum,
				extension: Xe.extension,
				confirmLabel: i("confirm"),
				cancelLabel: i("cancel"),
				closeLabel: i("close"),
				onConfirm: (e) => void on(e),
				onClose: () => Ze(null)
			}),
			Qe && /* @__PURE__ */ (0, S.jsx)(ee, {
				...Qe,
				confirmLabel: i("confirm"),
				cancelLabel: i("cancel"),
				closeLabel: i("close"),
			...
			nt && I && /* @__PURE__ */ (0, S.jsx)(ie, {
				initial: Le.tags[I.path] || [],
				suggestions: Array.from(new Set(Object.values(Le.tags).flat())).sort((e, t) => e.localeCompare(t, n)),
				labels: {
					title: i("tags"),
					close: i("close"),
					cancel: i("cancel"),
				...
				onClose: () => rt(!1),
				onSave: (e) => {
					rt(!1), t.updateMetadata(c, I.path, "tags", { tags: e }).then(Re).catch(M);
				}
			}),
			ot && /* @__PURE__ */ (0, S.jsx)(C, {
				title: ot.name,
				closeLabel: i("close"),
				onClose: () => st(null),
				...
				children: /* @__PURE__ */ (0, S.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, S.jsx)("div", {
						...
						children: jt(ot) ? /* @__PURE__ */ (0, S.jsx)(ce, {
							src: t.thumbnailUrl(c, ot, 512, 512),
							alt: ot.name
						}) : /* @__PURE__ */ (0, S.jsxs)("div", {
							className: "sf-file-preview-fallback",
							children: [/* @__PURE__ */ (0, S.jsx)(oe, { kind: "file" }), /* @__PURE__ */ (0, S.jsx)("p", { children: i("previewUnavailable") })]
						})
					}), /* @__PURE__ */ (0, S.jsxs)("dl", {
						className: "sf-file-preview-meta",
						children: [
							/* @__PURE__ */ (0, S.jsx)("dt", { children: i("type") }),
							/* @__PURE__ */ (0, S.jsx)("dd", { children: ot.mimeType || i("file") }),
							/* @__PURE__ */ (0, S.jsx)("dt", { children: i("size") }),
							/* @__PURE__ */ (0, S.jsx)("dd", { children: le(ot.size) }),
							/* @__PURE__ */ (0, S.jsx)("dt", { children: i("modified") }),
							/* @__PURE__ */ (0, S.jsx)("dd", { children: /* @__PURE__ */ (0, S.jsx)("time", {
								dateTime: (/* @__PURE__ */ new Date(ot.modifiedAt * 1e3)).toISOString(),
								children: a.format(ot.modifiedAt * 1e3)
							}) }),
							/* @__PURE__ */ (0, S.jsx)("dt", { children: i("location") }),
							/* @__PURE__ */ (0, S.jsx)("dd", { children: ot.path })
						]
					})]
				})
			}),
			ct && /* @__PURE__ */ (0, S.jsx)(ae, {
				url: ct.url,
				loginRequired: ct.loginRequired,
				labels: {
					title: i("fileUrl"),
					close: i("close"),
					copied: i("urlCopied"),
			...
			Je && I && ze && /* @__PURE__ */ (0, S.jsx)(T, {
				...
				onSave: async (e, n) => {
					...
					Ye(!1), Me(`${i("imageCreated")}: ${r.entry.name} · ${r.result.width} × ${r.result.height} px`), await N();
				}
			}),
			it && /* @__PURE__ */ (0, S.jsx)(te, {
				x: it.x,
				y: it.y,
				onClose: () => at(null),
				onSelect: ln,
				items: [
					{
						id: it.entry.directory ? "open" : "preview",
						label: it.entry.directory ? i("open") : i("preview")
					},
					...e.selectMode && !it.entry.directory ? [{
						id: "select",
						label: i("select"),
						disabled: !Nt(it.entry)
					}] : [],
					{
						id: "download",
						label: i("download"),
						disabled: it.entry.directory
					},
					{
						id: "rename",
						label: i("rename"),
						disabled: it.entry.capabilities?.rename === !1
					},
					{
						id: "copy",
						label: i("copy"),
						disabled: it.entry.capabilities?.copy === !1
					},
					{
						id: "move",
						label: i("move"),
						disabled: it.entry.capabilities?.move === !1
					},
					{
						id: "delete",
						label: i("remove"),
						disabled: it.entry.capabilities?.delete === !1,
						danger: !0
					}
				]
			}),
			/* @__PURE__ */ (0, S.jsx)("div", {
				className: "sf-sr-only",
				"aria-live": "polite",
				children: F.length > 0 ? `${F.length} ${i("selectedCount")}` : je
			})
		]
	});
}
//#endregion
//#region src/main.tsx
var _e = document.getElementById("sofinder-root");
if (!_e) throw Error("SoFinder root element was not found.");
var ve = JSON.parse(_e.dataset.config || "{}");
(0, u.createRoot)(_e).render(/* @__PURE__ */ (0, S.jsx)(l.StrictMode, { children: /* @__PURE__ */ (0, S.jsx)(ge, { config: ve }) }));
//#endregion
