...
var e = {
	...
	favoritesPageHint: "当前资源中保存的收藏链接；打开项目后会定位到它所在的文件夹。",
	searchFavorites: "搜索收藏夹",
	removeFavorite: "取消收藏",
	favoriteMissing: "该收藏项目已不存在，已从列表移除。",
	quickAccess: "快速访问",
	quickAccessEmpty: "暂无快速访问项目。",
	quickAccessMissing: "该快捷项已不存在；打开后会清理失效链接。",
	quickAccessRemoved: "该快速访问项目已不存在，已从列表移除。",
	pinQuickAccess: "加入快速访问",
	unpinQuickAccess: "从快速访问移除",
	moreItems: "项未展开",
	documents: "文档",
	audio: "音频",
	video: "视频",
