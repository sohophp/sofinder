...
var e = {
	...
	favoritesPageHint: "目前資源中儲存的收藏連結；開啟項目後會定位到它所在的資料夾。",
	searchFavorites: "搜尋收藏夾",
	removeFavorite: "取消收藏",
	favoriteMissing: "該收藏項目已不存在，已從清單移除。",
	quickAccess: "快速存取",
	quickAccessEmpty: "暫無快速存取項目。",
	quickAccessMissing: "該快速項目已不存在；開啟後會清理失效連結。",
	quickAccessRemoved: "該快速存取項目已不存在，已從清單移除。",
	pinQuickAccess: "加入快速存取",
	unpinQuickAccess: "從快速存取移除",
	moreItems: "項未展開",
	documents: "文件",
	audio: "音訊",
	video: "影片",
