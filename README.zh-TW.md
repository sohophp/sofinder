...
SoFinder 是原創、採 MIT 授權的網頁檔案管理器，支援 PHP 8.1 至 8.5，包含與框架無關的核心、Symfony 6.4／7.4 Bundle，以及 React 使用者介面。PHP 8.1 支援 Core、HTTP、PSR-15、S3 與 Symfony 6.4；Symfony 7.4 和 Laravel 12／13 仍要求 PHP 8.2 或更新版本。
