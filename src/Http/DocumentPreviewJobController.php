...
{
    public function __construct(private DocumentPreviewJobManager $jobs, private CsrfGuard $csrf, private RouterInterface $router, private ?FeaturePolicy $features = null) {}
