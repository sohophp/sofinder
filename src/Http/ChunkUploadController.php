...
{
    public function __construct(private FileManager $files, private ChunkUploadManager $chunks, private CsrfGuard $csrf)
    {
    }
    ...
    public function upload(Request $request): JsonResponse
    {
        ...
        try {
            $state = $this->chunks->accept($id, $request->request->getInt('index', -1), $request->request->getInt('total'), $stream, $limit);
