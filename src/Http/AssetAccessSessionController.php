...
{
    public function __construct(private AssetAccessSessionManager $sessions, private CsrfGuard $csrf, private RouterInterface $router, private ContentController $content) {}
    ...
    public function revoke(Request $request, string $id): JsonResponse { $this->csrf->assertMutation($request); $this->sessions->revoke($id); return new JsonResponse(OperationResult::success([])); }
