...
interface ChunkUploadStoreInterface
{
     ...
     * @param array{resource?:string,path?:string,name?:string,overwrite?:bool,autoRename?:bool} $context
    ...
    /** @return array{id:string,total:int,received:list<int>,complete:bool,resource:string,path:string,name:string,overwrite:bool,autoRename:bool,updatedAt:int} */
