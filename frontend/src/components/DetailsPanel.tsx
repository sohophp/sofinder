...
export function DetailsPanel({ api, resource, selectedEntries, selected, imageInfo, metadata, showTags, previewImage, selectMode, selectAllowed, assetMetadataEnabled, labels, formatDate, onChoose, onShare, onAssetMetadata, pluginActions }: {
  ...
  labels: { details: string; selected: string; type: string; folder: string; file: string; size: string; dimensions: string; modified: string; location: string; select: string; download: string; share: string; assetMetadata?: string; unsupportedWebImage: string };
