const messages = {
  en: {
    ...
    sort: "Sort", direction: "Sort direction", pagination: "Pagination", page: "Page", previous: "Previous", next: "Next", moreActions: "More actions",
    ...
    dimensions: "Dimensions", width: "Width", height: "Height", settings: "Settings", interfaceScale: "Interface size", scaleCompact: "Compact (90%)", scaleStandard: "Standard (100%)", scaleLarge: "Large (112.5%)", scaleExtraLarge: "Extra large (125%)", imageTools: "Image tools", rotationTools: "Rotation controls",
    ...
    ratio: "Ratio", freeRatio: "Free", originalRatio: "Original", zoom: "Zoom", undo: "Undo", redo: "Redo", reset: "Reset", compare: "Hold to compare", saveMode: "Save mode", saveCopy: "Save as copy", imageCreated: "Image created", panHint: "Drag outside the selection to draw a new crop; drag its corners or edges to resize it; arrow keys nudge one pixel.", open: "Open", preview: "Preview", previewUnavailable: "A visual preview is not available for this file type.",
  },
  "zh-cn": {
    ...
    sort: "排序", direction: "排序方向", pagination: "分页", page: "第", previous: "上一页", next: "下一页", moreActions: "更多操作",
    ...
    dimensions: "图片尺寸", width: "宽度", height: "高度", settings: "设置", interfaceScale: "界面大小", scaleCompact: "紧凑（90%）", scaleStandard: "标准（100%）", scaleLarge: "大（112.5%）", scaleExtraLarge: "特大（125%）", imageTools: "图片工具", rotationTools: "旋转工具",
    ...
    ratio: "比例", freeRatio: "自由比例", originalRatio: "原图比例", zoom: "缩放", undo: "撤销", redo: "重做", reset: "重置", compare: "按住前后对比", saveMode: "保存方式", saveCopy: "另存副本", imageCreated: "已生成图片", panHint: "在选区外拖动可重新框选；拖动四角或边线可调整大小，方向键每次微调一个像素。", open: "打开", preview: "预览", previewUnavailable: "此文件类型暂不支持可视化预览。",
  },
} as const;
...
const traditionalChinese: Record<MessageKey, string> = {
  ...
  sort: "排序", direction: "排序方向", pagination: "分頁", page: "第", previous: "上一頁", next: "下一頁", moreActions: "更多操作",
  ...
  dimensions: "圖片尺寸", width: "寬度", height: "高度", settings: "設定", interfaceScale: "介面大小", scaleCompact: "緊湊（90%）", scaleStandard: "標準（100%）", scaleLarge: "大（112.5%）", scaleExtraLarge: "特大（125%）", imageTools: "圖片工具", rotationTools: "旋轉工具",
  ...
  ratio: "比例", freeRatio: "自由比例", originalRatio: "原圖比例", zoom: "縮放", undo: "復原", redo: "重做", reset: "重設", compare: "按住以比較前後差異", saveMode: "儲存方式", saveCopy: "另存副本", imageCreated: "已產生圖片", panHint: "在選取範圍外拖曳可重新框選；拖曳四角或邊線可調整大小，方向鍵每次微調一個像素。", open: "開啟", preview: "預覽", previewUnavailable: "此檔案類型暫不支援視覺預覽。",
};
