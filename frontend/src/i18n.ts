const messages = {
  en: {
    ...
    sort: "Sort", direction: "Sort direction", pagination: "Pagination", page: "Page", previous: "Previous", next: "Next", itemsPerPage: "Items per page", moreActions: "More actions",
  ...
  "zh-cn": {
    ...
    sort: "排序", direction: "排序方向", pagination: "分页", page: "第", previous: "上一页", next: "下一页", itemsPerPage: "每页数量", moreActions: "更多操作",
...
const traditionalChinese: Record<MessageKey, string> = {
  ...
  sort: "排序", direction: "排序方向", pagination: "分頁", page: "第", previous: "上一頁", next: "下一頁", itemsPerPage: "每頁數量", moreActions: "更多操作",
