const messages = {
  en: {
    ...
    details: "Details", type: "Type", folder: "Folder", file: "File", location: "Location", chooseFolder: "Destination folder", fileUrl: "File URL", copyUrl: "Copy URL", urlCopied: "URL copied", copyUrlFailed: "Copy failed. The URL is selected for manual copying.", loginRequired: "Login required",
  ...
  "zh-cn": {
    ...
    details: "详细信息", type: "类型", folder: "文件夹", file: "文件", location: "位置", chooseFolder: "目标文件夹", fileUrl: "文件网址", copyUrl: "复制网址", urlCopied: "网址已复制", copyUrlFailed: "复制失败，已选中网址，请手动复制。", loginRequired: "需要登录",
